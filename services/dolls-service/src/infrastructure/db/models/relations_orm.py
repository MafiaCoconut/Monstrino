...
class RelationsORM(Base):
    ...
    src: Mapped[ReleasesORM] = relationship(foreign_keys=[release_id], back_populates="relations_out")
    dst: Mapped[ReleasesORM] = relationship(foreign_keys=[related_release_id], back_populates="relations_in")