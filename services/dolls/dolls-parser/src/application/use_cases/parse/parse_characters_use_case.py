...
class ParseCharactersUseCase:
    def __init__(self,
                 parsed_character_repository: ParsedCharactersRepository,
                 registry: PortsRegistry,
                 ):
        self.parsed_character_repository = parsed_character_repository
        self._r = registry
    ...
    async def _save_batch(self, batch: list[ParsedCharacter]):
        for character in batch:
            try:
                ...
                await self.parsed_character_repository.save(character)
