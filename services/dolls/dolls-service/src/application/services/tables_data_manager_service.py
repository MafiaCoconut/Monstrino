...
class TablesDataManagerService:
    def __init__(self,
        ...
        self.manage_dolls_types_uc = ManageDollsTypesUseCase(
            self.repositories.dolls_types)
        self.manage_dolls_series_uc = ManageDollsSeriesUseCase(
            self.repositories.dolls_series)
        self.manage_original_characters_uc = ManageOriginalCharactersUseCase(
            self.repositories.original_characters)
