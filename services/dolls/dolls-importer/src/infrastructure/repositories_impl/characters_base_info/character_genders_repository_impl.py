...
from application.repositories.characters_base_info.character_genders_repository import CharacterGendersRepo
from infrastructure.db.base import async_session_factory

logger = logging.getLogger(__name__)

class CharacterGendersRepoImpy(CharacterGendersRepo):
