...
# from application.repositories.destination.reference.character_gender_repository import CharacterGendersRepository
...
class ProcessCharactersUseCase:
    def __init__(self,
                 parsed_character_repo,
                 characters_repo,
                 characters_genders_repo,
                 ):
        self.parsed_character_repo = parsed_character_repo
    ...
    async def execute(self):
        ...
        for unprocessed_character in unprocessed_characters:
            try:
                ...
                logger.info(
                    f"Character {unprocessed_character.display_name} marked as processed")
