...
async def test_process_series_batch_success(
    ...
    async with uow_factory.create() as uow:
        ...
        parent_series = await uow.repos.series.get_one_by_fields_or_none(
        ...
        child_series = await uow.repos.series.get_one_by_fields_or_none(
        ...
        parsed_parent_after = await uow.repos.parsed_series.get_one_by_fields_or_none(
            id=parent_parsed.id
        )
