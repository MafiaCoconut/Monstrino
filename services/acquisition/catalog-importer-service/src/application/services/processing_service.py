...
# from application.use_cases.processing.series.process_series_use_case import ProcessSingleSeriesUseCase
...
class ProcessingService:
    ...
    #     )
    #     self.process_series_uc = ProcessSingleSeriesUseCase(
