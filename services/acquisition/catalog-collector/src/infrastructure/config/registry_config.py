...
def config(adapters: Adapters):
    registry.register(WebsiteKey.HMArchive, ParseCharactersPort,
                      adapters.mh_archive_parse_characters)
    registry.register(WebsiteKey.HMArchive, ParsePetsPort,
                      adapters.mh_archive_parse_pets)
    registry.register(WebsiteKey.HMArchive, ParseSeriesPort,
                      adapters.mh_archive_parse_series)
    registry.register(WebsiteKey.HMArchive, ParseReleasesPort,
