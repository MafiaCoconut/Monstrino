...
from infrastructure.api.responces.models import GetDataResponseModel, GetLegosetsTopRatingResponseModel
# from infrastructure.endpoints.setup import setup
#
# setup()
...
# @log_api_decorator()
# @app.get("/api/v1/users/registrationNewUser")
# async def
"""
TODO
